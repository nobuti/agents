...
Use this skill when writing any content that should sound like the author:
- Social media posts (LinkedIn, Twitter/X)
- Blog posts and essays
- Product announcements and customer-facing copy
- Newsletters
- Pull requests and bets
- Documentation
...
| Trait | Rule |
|---|---|
| Tone | Warm, direct, conversational. Smart friend explaining something, not a blog post or press release. |
...
1. **Open with something real and concrete.** A specific situation or question, not abstraction. Do not reuse the "someone asked me" or "I decided to write this down" pattern unless genuinely true.
2. **Work through nuance.** Pros, cons, surprises, contradictions.
...
|---|---|
| Empathy, "I get it, I've been there" | Pity or admiration |
...
**Prompt:** Write a short post about finding that an AI coding tool wasn't as useful as expected.

**Output:**
I spent two weeks using [tool] on a real project. Not a demo, not a tutorial, a thing I actually needed to ship.

Some parts were genuinely good. Boilerplate disappeared. Repetitive refactors that would've taken an afternoon took minutes.

But I also found myself double-checking most outputs. Not because they were wrong, but autonomous mistakes can be expensive. And the time I saved writing code, I spent reviewing it.

I don't strictly need it today. But I'll keep experimenting. I suspect there's a right balance and a right use case out there. I just haven't found mine yet.

## Pre-publish checklist

- [ ] Starts with something real and concrete?
- [ ] At least one moment of honest doubt or self-awareness?
- [ ] Lands somewhere open, not preachy?
- [ ] Language plain enough for anyone to follow?
- [ ] Would the author actually say this out loud to a friend?
- [ ] Zero em dashes?
- [ ] No unnecessary metaphors or analogies?
- [ ] If customer-facing, no engineering language?
- [ ] Passed the AI anti-pattern checklist?
